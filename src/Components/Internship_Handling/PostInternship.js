...
function PostInternship(props){
    ...
    return(
        <div>
            ...
            <div className = "container my-5 p-3" style = {{width:"75%"}}>

                <h1 className = "text-center">Post Internship</h1>
                ...
                <form className = "mt-5 registration-form">
                    ...
                    <div class="mb-4 mt-4">
                        <label for="internshipDescription" class="form-label">About Internship</label>
                        <textarea 
